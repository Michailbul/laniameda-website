...
export function TimelineDemo() {
  const data: TimelineEntry[] = [
    {
      title: "Creative Treatment Package — $2,000",
      content: (
        <div>
          <p className="text-neutral-800 text-xs md:text-sm font-normal mb-3">
            Delivery: 5 business days
          </p>
          <p className="text-neutral-800 text-xs md:text-sm font-normal mb-8">
            Scope: strategy + system + decision rules (not content production)
          </p>
    ...
    {
      title: "Section Current state (today)",
      content: (
        <div>
          <p className="text-neutral-800 text-xs md:text-sm font-normal mb-8">
            What you have: e-shop
          </p>
          <p className="text-neutral-800 text-xs md:text-sm font-normal mb-8">
            What you don’t have: audience + repeatable branded high quality content engine to monetize the audience
          </p>
          <div className="grid grid-cols-2 gap-4">
            <Image
    ...
    {
      title: "Whats next? (timeline)",
      content: (
        <div>
          <div className="mb-8">
            <div className="text-neutral-700 text-xs md:text-sm">
              Expand to more platforms only after proof
            </div>
            <div className="text-neutral-700 text-xs md:text-sm mt-2">
