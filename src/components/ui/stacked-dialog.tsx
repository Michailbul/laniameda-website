...
export const DialogStackContent = ({
    ...
    return (
        <div
            onClick={handleClick}
            className={cn(
                "size-full rounded-[22px] border-2 border-white/10 bg-zinc-950 p-2 shadow-lg transition-all duration-300",
                className
            )}
            style={{
                top: 0,
        ...
        >
            <div
                className={cn(
                    "size-full rounded-[14px] border border-white/5 bg-zinc-900/80 p-4 shadow-sm transition-all duration-300",
