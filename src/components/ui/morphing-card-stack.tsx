...
export function Component({
  ...
  return (
    <div className={cn("space-y-4", className)}>
                ...
                >
                  <div className="flex items-start gap-3">
                    {card.icon && (
                      <div
                        className={cn(
                          "flex h-10 w-10 shrink-0 items-center justify-center rounded-lg bg-secondary text-foreground",
                          iconClassName,
                        )}
                      >
                        {card.icon}
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      <p
                        className={cn(
                          ...
                          layout === "list" && (isExpanded ? "line-clamp-none" : "line-clamp-2"),
                        )}
                      >
                        {card.description}
                      </p>
      ...
      {showPagination && layout === "stack" && cards.length > 1 && (
