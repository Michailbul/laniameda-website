  ...
  return (
    <div className="relative h-full w-full">
      ...
      <div className="relative z-10 flex h-full flex-col justify-end p-5">
        {item.tag && (
          <span className="absolute top-4 left-4 px-2 py-1 text-[10px] font-mono uppercase tracking-wider bg-black/50 backdrop-blur-sm border border-white/10 rounded-md text-cyan-400">
            {item.tag}
          </span>
        )}
