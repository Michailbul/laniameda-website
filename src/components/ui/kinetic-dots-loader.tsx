            ...
            <div className='flex gap-5'>
                {[...Array(dots)].map((_, i) => (
                    ...
                    >
                        ...
                        >
                            <div
                                className='w-full h-full rounded-full bg-gradient-to-b from-gray-200 to-black shadow-[0_0_15px_rgba(0,0,0,0.3)]'
                                style={{
                        ...
                        <div
                            className='absolute bottom-0 w-10 h-3 border border-black/20 rounded-[100%] opacity-0'
                            style={{
                        ...
                        {/* 3. REFLECTIVE SHADOW */}
                        <div
                            className='absolute -bottom-1 w-5 h-1.5 rounded-[100%] bg-black/20 blur-sm'
                            style={{
